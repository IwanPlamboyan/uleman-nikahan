...
const SuryadiFatonahMainInvitation = ({
  isOpen,
  togglePlayPause,
  isPlaying,
}) => {
      ...
      >
        ...
        <div className="z-50 w-full h-full bg-[url(/src/assets/sample2/ornbg-1.png)] bg-bottom bg-origin-border bg-contain bg-no-repeat">
          <div className="pt-10 text-center font-ebGaramond text-stone-700">
            ...
            <p className="tracking-[4.3px] text-[18px]">19 . 11 . 2025</p>
          </div>
        </div>
      </section>
          ...
          <div className="flex bg-white shadow-md rounded-lg overflow-hidden w-full border border-[#94A2B8]">
            ...
            <div className="w-full flex-1 px-5 py-4">
              ...
              <div className="mt-3">
                ...
                <div className="text-sm text-gray-600 leading-tight">
                  Kampung Sekehonje, RT02, RW06, Desa Melatiwangi, Kec.
                  Cilengkrang, Kabupaten Bandung
                </div>
              </div>

              <iframe
                src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d247.56165305605307!2d107.69888209628256!3d-6.892223695144833!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNsKwNTMnMzEuNiJTIDEwN8KwNDEnNTYuNyJF!5e0!3m2!1sid!2sid!4v1762247796133!5m2!1sid!2sid"
                style={{ width: "100%", border: 0, marginTop: "16px" }}
                allowfullscreen=""
                loading="lazy"
                referrerpolicy="no-referrer-when-downgrade"
              ...
              <div className="mt-4">
                <a
                  href="https://maps.app.goo.gl/G1ayuBTdd1LcnWRz7"
                  target="_blank"
                  className="flex justify-center items-center gap-1 text-sm bg-[#94A2B8] text-white px-3 py-1 rounded-full shadow hover:bg-[#8897af] transition"
                >
                  <MapPin size={16} />
...
export default SuryadiFatonahMainInvitation;
