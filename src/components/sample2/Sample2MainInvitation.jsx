...
const Sample2MainInvitation = ({ isOpen, togglePlayPause, isPlaying }) => {
  ...
  const handleSaveDate = () => {
    const title = "Pernikahan Fulan & Fulanah 💍";
    ...
    const details = "Bergabunglah dalam hari bahagia kami di Gedung.";
    const location = "Gedung ABCD, Bandung";
    ...
    <>
      ...
      >
        ...
        <div className="z-50 w-full h-full bg-[url(/src/assets/sample2/ornbg-1.png)] bg-bottom bg-origin-border bg-contain bg-no-repeat">
          <div className="pt-10 text-center font-ebGaramond text-stone-700">
            <p>THE WEDDING OF</p>
            <p className="text-[2.5em]">Rizky & Siti</p>
            <p className="tracking-[4.3px] text-[18px]">22 . 11 . 2025</p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="py-24 px-14 flex flex-col justify-center items-center font-ebGaramond text-center text-slate-800">
          ...
          <p className="mt-6 font-tangerine text-6xl font-bold">Ikhwan</p>
          <p className="font-semibold text-2xl">Ikhwan Fulan</p>
          ...
          <p className="mt-6 font-tangerine text-6xl font-bold">Akhwat</p>
          <p className="font-semibold text-2xl">Akhwat Fulanah</p>
          <p className="leading-5">
            Anak Pertama dari
            <br />
            Bapak Fulan
            ...
            <div className="w-full flex-1 px-5 py-4">
              ...
              <div className="mt-3">
                ...
                <div className="text-sm text-gray-600 leading-tight">
                  Rumah Panggung Darusalam Bandung
                </div>
              </div>
              ...
              <div className="mt-4">
                <a
                  href="https://maps.app.goo.gl/d24sci6NEXYYxBrG8"
                  target="_blank"
...
export default Sample2MainInvitation;
