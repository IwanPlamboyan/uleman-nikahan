...
import SuryadiFatonahCover from "../components/suryadi-fatonah/SuryadiFatonahCover";
import SuryadiFatonahMainInvitation from "../components/suryadi-fatonah/SuryadiFatonahMainInvitation";

const SuryadiFatonahPage = () => {
  useEffect(() => {
...
export default SuryadiFatonahPage;
